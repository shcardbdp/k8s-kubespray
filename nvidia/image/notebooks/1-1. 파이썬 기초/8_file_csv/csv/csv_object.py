...
with open(
    "korea_floating_population_data.csv","r",
    encoding="cp949") as p_file:
...
with open("seoung_nam_floating_population_data.csv","w",
    encoding="utf8") as s_p_file:
    writer = csv.writer(
        s_p_file, delimiter='\t', quotechar="'",
